var data = [ {
  ...
  "helpline"           : [
    ...
    "p7"               : "Monday to Friday, 9am to 5pm",
  ...
  "helper" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#helper",
      "backLink"         : "/release2-2/yscMenu"
    },
  ],
  "aboutYou" : [
    {
      ...
      "question6"        : "Title",
      "validateLink"     : "/release2-2/validationPage#aboutYou",
      "backLink"         : "/release2-2/helper"
    },
  ],
  "contactDetails" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#contactDetails",
      "phoneHintText"    : "Enter the number you can be contacted on between 8.30am and 5pm, Monday to Friday.",
      "backLink"         : "/release2-2/aboutYou"
    },
  ],
  "contactPref" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#contactPref",
      "backLink"         : "/release2-2/contactDetails"
    },
  ],
  "bankDetails" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#bankDetails",
      "backLink"         : "/release2-2/contactPref"
    }
  ],
  "currentWhereabouts" : [
    {
      ...
      "question4"        : "Postcode",
      "validateLink"     : "/release2-2/validationPage#currentWhereabouts",
      "backLink"         : "/release2-2/nationality"
    }
  ],
  "nationality" : [
    {
      ...
      "q5HintText"       : "",
      "validateLink"     : "/release2-2/validationPage#nationality",
      "backLink"         : "/release2-2/bankDetails"
    },
  ],
  "paymentsFromAbroad" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#paymentsFromAbroad",
      "backLink"         : "/release2-2/currentWhereabouts"
    },
  ],
  ...
  "yourCondition" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#yourCondition",
      "backLink"         : "/release2-2/declaration"
    },
  ],
  ...
  "conditionDetails" : [
    {
      ...
      "removeLink"       : "",
      "validateLink"     : "/release2-2/validationPage#conditionDetails",
      "backLink"         : "/release2-2/healthcareprofessional"
    },
  ],
  "medications" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#medications",
      "backLink"         : "/release2-2/conditionDetails"
    },
  ],
  "manageMedications" : [
    {
      ...
      "question2"        : "Does your condition affect how you manage your medication?",
      ...
      "validateLink"     : "/release2-2/validationPage#manageMedications",
      "backLink"         : "/release2-2/medications"
    },
  ],
  "treatments" : [
    {
      ...
      "removeLink"       : "",
      "question2"        : "Do you have treatment or therapy in your home?",
      "validateLink"     : "/release2-2/validationPage#treatments",
      "backLink"         : "/release2-2/manageMedications"
    },
  ],
  "manageTreatments" : [
    {
      ...
      "question3"        : "<h3 class=heading-medium>Why does someone need to help you manage your treatment or therapy at home?<h3>",
      "question4"        : "<h3 class=heading-medium>How does someone help you manage your treatment or therapy at home?<h3>",
      "validateLink"     : "/release2-2/validationPage#manageTreatments",
      "backLink"         : "/release2-2/treatments"
    },
  ],
  "sideEffects" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#sideEffects",
      "backLink"         : "/release2-2/treatments"
    },
  ],
  "conditionAffects" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#conditionAffects",
      "backLink"         : "/release2-2/sideEffects"
    },
  ],
  "monitoringCondition" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#monitoringCondition",
      "backLink"         : "/release2-2/sideEffects"
    },
  ],
  "helpMonitoring" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#helpMonitoring",
      "backLink"         : "/release2-2/monitoringCondition"
    },
  ],
  "healthcareprofessional" : [
    {
      ...
      "introText"        : "<p>We want to know who could tell us more about how your condition affects you.</p><p>They could be your counsellor, teacher, key worker, doctor or anyone else who has information about the effects of your condition.</p>",
      ...
      "removeLink"       : "",
      "validateLink"     : "/release2-2/validationPage#healthcareprofessional",
      "backLink"         : "/release2-2/yourCondition"
    },
  ],
  ...
  "submitEvidence" : [
    {
      ...
      "introText"        : "<p>It can help your application if you send information that gives more detail about the effects of your condition.</p><p class=panel-indent>Only send what you've got to hand - nothing you have to pay to get hold of.</p><p>You need to send this within the next 2 weeks or a decision could be made without it. We cannot return any paperwork, so send photocopies if you can. The address will also be at the end of the application.</p>",
      "question"         : "You will send your:",
      "q2HintText"       : "Tick all that apply",
      "question3"        : "How will you send the information?",
      "validateLink"     : "/release2-2/validationPage#submitEvidence",
      "backLink"         : "/release2-2/helpMonitoring"
    },
  ],
  ...
  "youAndYourHome" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#youAndYourHome",
      "backLink"         : "/release2-2/submitEvidence"
    },
  ],
  ...
  "caringForYourself" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#caringForYourself",
      "backLink"         : "/release2-2/speech"
    },
  ],
  ...
  "leavingYourHome" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#leavingYourHome",
      "backLink"         : "/release2-2/eatingAndDrinking"
    },
  ],
  ...
  "makingSenseOfThings" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#makingSenseOfThings",
      "backLink"         : "/release2-2/mixing"
    },
  ],
  ...
  "specialAids" : [
    {
      ...
      "qHintText"         : "Include any aids or adaptations you need but have not got yet. Include anything you have adapted or made yourself.",
      "homeLabel"         : "Getting in or out of your home",
      ...
      "doesntLabel"       : "You do not have to use aids or adaptations",
      ...
      "validateLink"     : "/release2-2/validationPage#specialAids",
      "backLink"          : "/release2-2/youAndYourHome"
    },
  ],
  "sight" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#sight",
      "backLink"         : "/release2-2/gettingUp"
    },
  ],
  "speech" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#speech",
      "backLink"         : "/release2-2/sight"
    },
  ],
  "hearing" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#hearing",
      "backLink"         : "/release2-2/speech"
    },
  ],
  "gettingUp" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#gettingUp",
      "backLink"         : "/release2-2/specialAids"
    },
  ],
  "toilet" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#toilet",
      "backLink"         : "/release2-2/caringForYourself"
    },
  ],
  "washing" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#washing",
      "backLink"         : "/release2-2/toilet"
    },
  ],
  "gettingDressed" : [
    {
      ...
      "relyLabel"        : "You rely on aids or something else to help",
      "manageLabel"      : "You manage without help, but with difficulty",
      "question4"        : "In your own words, describe how your condition affects you getting dressed on a typical day.",
      "helpTextHd"       : "Include if:",
      ...
      "validateLink"     : "/release2-2/validationPage#gettingDressed",
      "backLink"         : "/release2-2/washing"
    },
  ],
  "hotMeal" : [
    {
      ...
      "question4"        : "In your own words, describe how your condition affects you cooking a hot meal from fresh ingredients on a typical day.",
      "helpTextHd"       : "Include if:",
      ...
      "validateLink"     : "/release2-2/validationPage#hotMeal",
      "backLink"         : "/release2-2/washing"
    },
  ],
  "eatingAndDrinking" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#eatingAndDrinking",
      "backLink"         : "/release2-2/hotMeal"
    },
  ],
  "gettingOut" : [
    {
      ...
      "gettingHint"      : "This includes if you find any part difficult or if you rely on someone to encourage you or help you leave your home.",
      "frequency"          : [
        {
      ...
      "question5"        : "Why does your condition affect you getting out and walking about?",
      "question6"        : "How do you get out and walk about?",
      "gettingHowHint"   : "Include if you have to use a wheelchair or other mobility aid.",
      "helpTextHd"       : "Include if:",
      ...
      "validateLink"     : "/release2-2/validationPage#gettingOut",
      "backLink"         : "/release2-2/leavingYourHome"
    },
  ],
  "mixing" : [
    {
      ...
      "question4"        : "In your own words, describe how your condition would affect you mixing with people when you have to",
      "helpTextHd"       : "Include if:",
      ...
      "validateLink"     : "/release2-2/validationPage#mixing",
      "backLink"         : "/release2-2/eatingAndDrinking"
    },
  ],
  "localJourney" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#localJourney",
      "backLink"         : "/release2-2/mixing"
    },
  ],
  "somewhereNeverBeenBefore" : [
    {
      ...
      "ownLabel"         : "You would manage without help, but with difficulty",
      "question3"        : "In your own words, describe how your condition affects you following a route on a typical day.",
      "helpTextHd"       : "Include if:",
      ...
      "validateLink"     : "/release2-2/validationPage#somewhereNeverBeenBefore",
      "backLink"         : "/release2-2/localJourney"
    },
  ],
  "somewhereYouKnow" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#somewhereYouKnow",
      "backLink"         : "/release2-2/somewhereNeverBeenBefore"
    },
  ],
  "understanding" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#understanding",
      "backLink"         : "/release2-2/somewhereNeverBeenBefore"
    },
  ],
  "money" : [
    {
      ...
      "ownLabel"         : "You would manage without help, but with difficulty",
      "otherWayLabel"    : "In another way",
      "question3"        : "In your own words, describe how your condition would affect you dealing with money if you had to.",
      "helpTextHd"       : "Include if:",
      ...
      "validateLink"     : "/release2-2/validationPage#money",
      "backLink"         : "/release2-2/understanding"
    },
  ],
  "additionalInfo" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#additionalInfo",
  ...
  "declaration" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage#declaration",
      "backLink"         : "/release2-2/paymentsFromAbroad"
    },
  ],
  "thankYou" : [
    {
  ...
  "submitApplication" : [
    {
      ...
      "validateLink"     : "/release2-2/validationPage",
      "backLink"         : "/release2-2/checkYourAnswers"
    },
  ],
